...
export default function HomePage() {
    ...
    const [value, setValue] = useState('चार पटक ओलम्पिकमा सहभागी बनेका बैकुण्ठ, जो आफ्नै गन्जी र कट्टु पहिरिएर दौडिए');
    ...
    const content = useSelector(state => state.placeDetails);
        ...
        <React.Fragment>
            ...
            <Paper className="header-chip-div" elevation={0} style={{
                ...
                <Chip onClick={(e) => handleCheapSelect("nearby")}
                      color={activeChip === "nearby" ? "primary" : "default"} className="header-chip" label="NearBy"/>
            ...
            <Paper style={{display: activeChip === "introduction" ? "flex" : "none"}}  className={classes.root} elevation={0}>
                ...
                <div style={headerStyle}>
                    ...
                    <div className="icons">
                        ...
                        <VolumeDown onClick={() => speak({text: value, voice: voice})} style={{marginRight: 8}}/>
                        <TranslateIcon/>
                    </div>
                ...
                <HorizontalList title="Audio" type="audio" data={audioData}/>
                <HorizontalList title="Video" type="video" data={audioData}/>
            ...
            <Paper style={{display: activeChip === "nearby" ? "flex" : "none"}} className={classes.root} elevation={0}>
                <HorizontalList title="Cafe" type="nearby" data={audioData}/>
                <HorizontalList title="Restaurant" type="nearby" data={audioData}/>
                <HorizontalList title="Hotels" type="nearby" data={audioData}/>
            </Paper>
